...
if [ "$1" == "db" ];then
        ...
        $ZIP -P qiniu-ubedu+3139406358 -m $back_path/$domain\_db_$TODAY\.zip $domain\_db_$TODAY\.sql
elif [ "$1" == "file" ];then
        domain=$2
        site_path=$3
        back_path=$4
        ...
        $ZIP -P qiniu-ubedu+3139406358 -9r $back_path/$domain\_$TODAY\.zip $site_path
elif [ "$1" == "--help" ];then
        clear
